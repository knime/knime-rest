...
import org.knime.rest.nodes.common.NoProxyRestNodeModel;
...
final class BypassGlobalProxyTest {
    ...
    private static NoProxyRestNodeModel dummyNodeModel;

    @BeforeAll
    public static void initializeModel() {
        dummyNodeModel = new NoProxyRestNodeModel();
    }
    ...
    void bypassAllProxies() {
        ...
        assertDoesNotThrow(() -> dummyNodeModel.makeRequest(),
        ...
        assertFalse(Arrays.stream(dummyNodeModel.getResponses()).allMatch(DataCell::isMissing),
