...
import org.knime.core.util.proxy.HttpMockServiceFactory;
import org.knime.core.util.proxy.PassthroughMarker;
...
final class ProxyRequestTest {
    ...
    @Test
    void noAuthHttpTest() {
        assertRequestFor(proxyNodeModel, //
            "http://httpbin.testing.knime.com/anything", null, "200");
    }
    ...
    void basicAuthHttpTest() {
        ...
        assertRequestFor(proxyNodeModel, //
            String.format("http://httpbin.testing.knime.com/basic-auth/%s/%s", user, passwd),
            createBasicAuthentication(user, passwd), "200");
    }
    ...
    void hiddenBasicAuthHttpTest() {
        ...
        assertRequestFor(proxyNodeModel, //
            String.format("http://httpbin.testing.knime.com/hidden-basic-auth/%s/%s", user, passwd),
            createBasicAuthentication(user, passwd), "200");
    }
    ...
    void digestAuthHttpTest() {
        ...
        assertRequestFor(proxyNodeModel, //
            String.format("http://httpbin.testing.knime.com/digest-auth/auth/%s/%s", user, passwd),
            createDigestAuthentication(user, passwd), "200");
    }
}
