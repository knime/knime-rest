...
final class RestPutNodeParametersTest extends DefaultNodeSettingsSnapshotTest {

    RestPutNodeParametersTest() {
        super(getConfig());
    }
    ...
    private static SnapshotTestConfiguration getConfig() {
        return SnapshotTestConfiguration.builder() //
            ...
            .testJsonFormsForModel(RestPutNodeParameters.class) //
            .testJsonFormsWithInstance(SettingsType.MODEL, () -> readSettings()) //
            .testNodeSettingsStructure(() -> readSettings()) //
            .build();
    }

    private static RestPutNodeParameters readSettings() {
        try {
            var path = getSnapshotPath(RestPutNodeParameters.class).getParent().resolve("node_settings")
                .resolve("RestPutNodeParameters.xml");
