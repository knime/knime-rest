...
/**
 * Snapshot test for {@link WebpageRetrieverNodeParameters}.
 */
@SuppressWarnings("restriction")
final class WebpageRetrieverNodeParametersTest extends DefaultNodeSettingsSnapshotTest {

    WebpageRetrieverNodeParametersTest() {
        super(getConfig());
    }
    ...
    private static SnapshotTestConfiguration getConfig() {
        return SnapshotTestConfiguration.builder() //
            ...
            .testJsonFormsForModel(WebpageRetrieverNodeParameters.class) //
            .testJsonFormsWithInstance(SettingsType.MODEL, () -> readSettings()) //
            .testNodeSettingsStructure(() -> readSettings()) //
            .build();
    }

    private static WebpageRetrieverNodeParameters readSettings() {
        try {
            var path = getSnapshotPath(WebpageRetrieverNodeParameters.class).getParent().resolve("node_settings")
                .resolve("WebpageRetrieverNodeParameters.xml");
