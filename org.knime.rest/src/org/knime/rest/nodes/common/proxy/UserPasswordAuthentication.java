 ...
 */
public record UserPasswordAuthentication(BasicAuthentication authentication) implements ProxyAuthentication {
    ...
    public void configure(final HTTPConduit conduit, final CredentialsProvider credsProvider) {
        ...
        authorization.setUserName(authentication.getUsername());
        authorization.setPassword(authentication.getPassword());
