...
public class RestNodeParameters implements NodeParameters {
    ...
    @ValueProvider(AuthViaInputPortStatusProvider.class)
    @ValueReference(IsAuthViaInputPortEnabledRef.class)
    boolean m_isAuthViaPortEnabled;
    ...
    static final class ConnectionTimeoutMigration implements NodeParametersMigration<Integer> {
        ...
        public List<ConfigMigration<Integer>> getConfigMigrations() {
            return List.of(ConfigMigration.builder(ConnectionTimeoutMigration::loadTimeout)
    ...
    @Widget(title = "Handling of invalid URLs", description = "Specifies how invalid URLs are handled.")
    @ValueSwitchWidget
    ...
    @Widget(title = "Rate-limiting error handling (HTTP 429)", description = """
            Pauses execution and retries when receiving rate limiting errors (HTTP 429).
            """)
    @ValueSwitchWidget
    ...
    static final class FailOnServerOrClientErrorsMigration implements NodeParametersMigration<ErrorHandlingPolicy> {
        ...
        public List<ConfigMigration<ErrorHandlingPolicy>> getConfigMigrations() {
            return List.of(ConfigMigration.builder(FailOnServerOrClientErrorsMigration::loadPolicy)
    ...
    static final class IsAuthViaInputPortEnabledRef implements ParameterReference<Boolean>{
    }
    ...
    static final class IsAuthViaInputPortEnabled implements EffectPredicateProvider {
        ...
        @Override
        public EffectPredicate init(final PredicateInitializer i) {
            return i.getBoolean(IsAuthViaInputPortEnabledRef.class).isTrue();
        }
    ...
    static final class AuthViaInputPortStatusProvider implements StateProvider<Boolean> {
        ...
        public Boolean computeState(final NodeParametersInput parametersInput) throws StateComputationFailureException {
            return parametersInput.getInPortObjects().length != 1;
        }
