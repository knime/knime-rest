...
public class RestPutNodeFactory extends RestNodeFactory<RestPutNodeModel>
    ...
    private static final String NODE_NAME = "PUT Request";

    private static final String NODE_ICON = "./rest-put.png";

    private static final String SHORT_DESCRIPTION = "PUT REST client";

    private static final String FULL_DESCRIPTION = """
            <p>This node can be used to issue HTTP PUT requests. PUT requests are commonly used to create or replace
            remote resources.</p>
    ...
    private static final List<PortDescription> INPUT_PORTS = List.of(
        fixedPort("Table", "Data table containing the variable parameters of the requests."),
    ...
    private static final List<PortDescription> OUTPUT_PORTS = List.of(
        fixedPort("PUT results", "Data table containing additional columns from the responses.")
    );
    ...
    public NodeDialog createNodeDialog() {
        return new DefaultNodeDialog(SettingsType.MODEL, RestPutNodeParameters.class);
    }
    ...
    public KaiNodeInterface createKaiNodeInterface() {
        return new DefaultKaiNodeInterface(Map.of(SettingsType.MODEL, RestPutNodeParameters.class));
    }
