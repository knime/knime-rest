...
public enum InvalidURIPolicy implements ButtonGroupEnumInterface {
     ...
     */
    public static final String INVALID_URI_ERROR = "Invalid URI";
    ...
    /**
     * Checks whether the given {@link MissingValue}, e.g. a missing cell is caused
     * by an invalid URI. This is identified by the presence of {@value #INVALID_URI_ERROR}.
     *
     * @param missing missing value
     * @return is caused by an invalid URI?
     */
    public static boolean isCausedByInvalidURI(final MissingValue missing) {
        return StringUtils.startsWith(missing.getError(), INVALID_URI_ERROR);
    }
    ...
    public FilterRowGenerator createRowFilter(final int columnIndex) {
        ...
        return row -> RestNodeModel.getURIFromRow(row, columnIndex).isPresent();
    }
}
